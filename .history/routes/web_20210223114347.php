...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    /** Planos x Perfils **/
    //Route::get('plans/{id}/profile/{idPermission}/detach', 'ACL\PlanProfileController@detachPlanProfile')->name('plans.permission.detach');
    //Route::post('plans/{id}/profiles', 'ACL\PlanProfileController@attachPermissionsProfile')->name('plans.profiles.attach');
    // Route::any('plans/{id}/profiles/create', 'ACL\PlanProfileController@permissionsAvailable')->name('plans.profiles.available');
